<?php
$thisproduct='Royal Canin-Golden Retriever Adult Dog Food';
        ...
        <div class="row">
            ...
            <div class="col">
                ...
                <div class="content">
                    ...
                    <h2> Royal Canin® Breed Health Nutrition™ Golden Retriever Adult Dog Food</h2>
                    <div class="rating">
                    ...
                    <br>
                    <p class = "product-price" style="text-decoration: line-through;color:red"> $85.55</p>
