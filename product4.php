<?php
$thisproduct='Top Paw - Double Door Wire Dog Crate';
...
<head>
    ...
    <title>Top Paw - Double Door Wire Dog Crate</title>
        ...
        <div class="row">
            ...
            <div class="col">
                ...
                <div class="content">
                    ...
                    <br>
                    <p class = "product-price" style="text-decoration: line-through;color:red"> $61.99</p>
