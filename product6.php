<?php
$thisproduct='Whisker City® Organic Catnip';
...
<head>
    ...
    <title>Whisker City® Organic Catnip</title>
        ...
        <div class="row">
            ...
            <div class="col">
                ...
                <div class="content">
                    ...
                    <br>
                    <p class = "product-price" style="text-decoration: line-through;color:red"> $7.99</p>
